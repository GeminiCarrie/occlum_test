...
impl OcclumExecClient {
    ...
    ) -> ::grpc::SingleResponse<HealthCheckResponse> {
    ...
    pub fn exec_command(
        &self,
        o: ::grpc::RequestOptions,
        req: super::exec::ExecCommRequest,
    ) -> ::grpc::SingleResponse<super::exec::ExecCommResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
    ...
    pub fn get_result(
        &self,
        o: ::grpc::RequestOptions,
        req: super::exec::GetResultRequest,
    ) -> ::grpc::SingleResponse<super::exec::GetResultResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
    ...
    pub fn stop_server(
        &self,
        o: ::grpc::RequestOptions,
        req: super::exec::StopRequest,
    ) -> ::grpc::SingleResponse<super::exec::StopResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
    ...
    pub fn kill_process(
        &self,
        o: ::grpc::RequestOptions,
        req: super::exec::KillProcessRequest,
    ) -> ::grpc::SingleResponse<super::exec::KillProcessResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
...
impl ::protobuf::Message for KillProcessRequest {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.signal != 0 {
            my_size +=
                ::protobuf::rt::value_size(2, self.signal, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn default_instance() -> &'static KillProcessRequest {
        static mut instance: ::protobuf::lazy::Lazy<KillProcessRequest> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(KillProcessRequest::new) }
    }
}
...
impl ::protobuf::Message for KillProcessResponse {
    ...
    fn default_instance() -> &'static KillProcessResponse {
        static mut instance: ::protobuf::lazy::Lazy<KillProcessResponse> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(KillProcessResponse::new) }
    }
}
...
impl ::protobuf::Message for GetResultRequest {
    ...
    fn default_instance() -> &'static GetResultRequest {
        static mut instance: ::protobuf::lazy::Lazy<GetResultRequest> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(GetResultRequest::new) }
    }
}
...
impl ::protobuf::Message for GetResultResponse {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.result != 0 {
            my_size +=
                ::protobuf::rt::value_size(2, self.result, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeEnum<GetResultResponse_ExecutionStatus>,
                >(
                    "status",
    ...
    fn default_instance() -> &'static GetResultResponse {
        static mut instance: ::protobuf::lazy::Lazy<GetResultResponse> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(GetResultResponse::new) }
    }
}
...
impl ::protobuf::Message for ExecCommRequest {
    ...
    fn default_instance() -> &'static ExecCommRequest {
        static mut instance: ::protobuf::lazy::Lazy<ExecCommRequest> = ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(ExecCommRequest::new) }
    }
}
...
impl ::protobuf::Message for ExecCommResponse {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeEnum<ExecCommResponse_ExecutionStatus>,
                >(
                    "status",
    ...
    fn default_instance() -> &'static ExecCommResponse {
        static mut instance: ::protobuf::lazy::Lazy<ExecCommResponse> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(ExecCommResponse::new) }
    }
}
...
impl ::protobuf::Message for HealthCheckRequest {
    ...
    fn default_instance() -> &'static HealthCheckRequest {
        static mut instance: ::protobuf::lazy::Lazy<HealthCheckRequest> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(HealthCheckRequest::new) }
    }
}
...
impl ::protobuf::Message for HealthCheckResponse {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeEnum<HealthCheckResponse_ServingStatus>,
                >(
                    "status",
    ...
    fn default_instance() -> &'static HealthCheckResponse {
        static mut instance: ::protobuf::lazy::Lazy<HealthCheckResponse> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(HealthCheckResponse::new) }
    }
}
...
impl ::protobuf::Message for StopRequest {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.time != 0 {
            my_size +=
                ::protobuf::rt::value_size(1, self.time, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn default_instance() -> &'static StopRequest {
        static mut instance: ::protobuf::lazy::Lazy<StopRequest> = ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(StopRequest::new) }
    }
}
...
impl ::protobuf::Message for StopResponse {
    ...
    fn default_instance() -> &'static StopResponse {
        static mut instance: ::protobuf::lazy::Lazy<StopResponse> = ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(StopResponse::new) }
    }
}
